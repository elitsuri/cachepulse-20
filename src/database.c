/* database.c — SQLite database layer for cachepulse */
#include "database.h"
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int db_init(const char *path) {
    ...
    const char *schema =
        "CREATE TABLE IF NOT EXISTS cachepulse_records ("
...
int db_insert(const char *name, const char *value) {
    const char *sql = "INSERT INTO cachepulse_records (name, value) VALUES (?, ?);";
    sqlite3_stmt *stmt;
